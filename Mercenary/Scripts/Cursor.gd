...
@onready var unit_sprite : Sprite2D = $UnitImage
...
func _set_unit_image(unit_image: Texture) -> void:
	unit_sprite.texture = unit_image

func _set_unit_image_scale(unit_scale: Vector2) -> void:
	unit_sprite.scale = unit_scale

func _hide_unit_image() -> void:
	unit_sprite.hide()

func _show_unit_image() -> void:
	unit_sprite.show()
